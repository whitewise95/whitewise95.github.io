...
<section class="series-board" aria-label="Category list">
  ...
  {% for category_name in category_names %}
    ...
    <li class="series-board-item">
      <a class="series-board-link" href="{% if category_name == 'Java' %}{{ '/java/' | relative_url }}{% elsif category_name == '회사생활' %}{{ '/company-life/' | relative_url }}{% elsif category_name == '항해플러스' %}{{ '/hanghae-plus/' | relative_url }}{% elsif category_name == '리액트 부트캠프' %}{{ '/react-bootcamp/' | relative_url }}{% else %}{{ '/categories/' | relative_url }}{% endif %}">
